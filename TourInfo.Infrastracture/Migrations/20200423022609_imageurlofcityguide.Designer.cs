...
namespace TourInfo.Infrastracture.Migrations
{
    ...
    [Migration("20200423022609_imageurlofcityguide")]
    partial class imageurlofcityguide
    {
                    ...
                    b.OwnsOne("TourInfo.Domain.DomainModel.SDTA.FoodDetail+Data+Destination", "destination", b1 =>
                        {
                            ...
                            b1.HasOne("TourInfo.Domain.DomainModel.SDTA.FoodDetail+Data")
                                .WithOne("destination")
                                .HasForeignKey("TourInfo.Domain.DomainModel.SDTA.FoodDetail+Data+Destination", "id")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
