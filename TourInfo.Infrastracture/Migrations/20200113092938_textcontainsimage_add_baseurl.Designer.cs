...
namespace TourInfo.Infrastracture.Migrations
{
    ...
    [Migration("20200113092938_textcontainsimage_add_baseurl")]
    partial class textcontainsimage_add_baseurl
    {
                    ...
                    b.OwnsOne("TourInfo.Domain.Base.TextContainsImageUrls", "details", b1 =>
                        {
                            ...
                            b1.HasOne("TourInfo.Domain.TourNews.ZbtaNews")
                                .WithOne("details")
                                .HasForeignKey("TourInfo.Domain.Base.TextContainsImageUrls", "ZbtaNewsid")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
