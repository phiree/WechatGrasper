...
namespace TourInfo.Infrastracture.Migrations
{
    ...
    [Migration("20220305093652_addvisitlog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourInfo.Domain.DomainModel.DataLog.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = "528a3ebc-775c-4fca-b125-f2b3389eca34",
                            AppId = "appid001",
                            AppSecret = "********",
                            Name = "大厅迎宾屏"
                        },
                        new
                        {
                            id = "e255daf9-3188-4e73-9849-5f510e265fad",
                            AppId = "appid002",
                            AppSecret = "********",
                            Name = "安卓客户端"
                        },
                        new
                        {
                            id = "15da55b8-511f-402a-9d42-637cd87a6405",
                            AppId = "appid003",
                            AppSecret = "********",
                            Name = "一号大屏"
                        },
                        new
                        {
                            id = "64afbfcf-62a8-40c5-9815-ad660288108f",
                            AppId = "appid004",
                            AppSecret = "********",
                            Name = "二号大屏"
                        },
                        new
                        {
                            id = "db1ea02d-1031-440c-bcae-036027e96001",
                            AppId = "appid005",
                            AppSecret = "********",
                            Name = "三号大屏"
                        });
            ...
            modelBuilder.Entity("TourInfo.Domain.DomainModel.DataLog.DataSource", b =>
                {
                    b.Property<string>("id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TourInfo.Domain.DomainModel.DataLog.DistributeLog", b =>
                {
                    b.Property<string>("id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("DistributeAmount");

                    b.Property<DateTime>("DistributeBeginTime");

                    b.Property<DateTime>("DistributeEndTime");

                    b.HasKey("id");

                    b.ToTable("DistributeLogs");
                });

            modelBuilder.Entity("TourInfo.Domain.DomainModel.DataLog.FetchLog", b =>
                {
                    b.Property<string>("id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("FetchAmount");

                    b.Property<DateTime>("FetchBeginTime");

                    b.Property<DateTime>("FetchEndTime");
            ...
            modelBuilder.Entity("TourInfo.Domain.DomainModel.VisitLog", b =>
                {
                    b.Property<string>("id")
                        .ValueGeneratedOnAdd();
