...
namespace TourInfo.Domain.DomainModel.SDTA
{
    public class SDTALineGrasperService : ISDTALineGrasperService
    {
        ...
        public SDTALineGrasperService(IUrlFetcher urlFetcher, IRepository<LineDetail, string> lineRepository, IRepository<LineDetailScenic.Doc.Source, string> lineDetailScenicRepository)
        {
            ...
            this.lineLocalizer = new InfoLocalizer<LineDetail, string>(lineRepository, urlFetcher, "..\\DownloadImages\\sdta\\","/DownloadImages/sdta/");
            this.lineDetailScenicLocalizer = new InfoLocalizer<LineDetailScenic.Doc.Source, string>(lineDetailScenicRepository, urlFetcher, "..\\DownloadImages\\sdta\\", "/DownloadImages/sdta/");
        }
